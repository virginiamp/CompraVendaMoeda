...
namespace TesteForm {
	...
	private:
		...
		int controleBox4, controleBox6 = 0;
		String ^ str = "([0-9]+,[0-9]{3,3})([0-9]+)$";
		String ^ str2 = "([0-9]+,[0-9]{5,5})([0-9]+)$";
...
#pragma region Windows Form Designer generated code
			 ...
			 void InitializeComponent(void)
			 {
				 ...
				 this->label24->Font = (gcnew System::Drawing::Font(L"Calibri", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
					 static_cast<System::Byte>(0)));
				 this->label24->Location = System::Drawing::Point(494, 372);
				 this->label24->Name = L"label24";
				 this->label24->Size = System::Drawing::Size(62, 19);
				 this->label24->TabIndex = 33;
				 this->label24->Text = L"ou     R$";
				 // 
				 // textBox6
				 // 
				 ...
				 this->label32->Font = (gcnew System::Drawing::Font(L"Calibri", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
					 static_cast<System::Byte>(0)));
				 this->label32->Location = System::Drawing::Point(341, 374);
				 this->label32->Name = L"label32";
				 this->label32->Size = System::Drawing::Size(28, 19);
				 ...
				 this->label8->Location = System::Drawing::Point(40, 405);
...
#pragma endregion
	private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
		...
		int controle1, controle2, controle6 = 0;
		...
		if (!String::IsNullOrEmpty(this->textBox2->Text)) {
			...
			label43->Text = L"Campo obrigatório";
			controle2 = 1;
		}
		...
		if (!String::IsNullOrEmpty(this->textBox1->Text)) {
			...
			label42->Text = L"Campo obrigatório";
			controle1 = 1;
		}
		...
		if (!String::IsNullOrEmpty(this->textBox6->Text)) {
			...
			if (!String::IsNullOrEmpty(this->textBox4->Text))
			{
				double L25 = Convert::ToDouble(this->label25->Text);
				if (L25 != LR) {
					label8->Text = "preencha apenas 1 dos campos ou\no valor deles deve ser correspondente";
					controle6 = 1;
				}
				else {
					controle6 = 0;
		...
		if ((controle1 == 0)&&(controle2 == 0)&&(controle6==0)) {
			if (Regex::IsMatch(Convert::ToString(valorVenda),str)) {
				label10->Text = Regex::Replace(Convert::ToString(valorVenda), str, "$1");
			} else {
				label10->Text = Convert::ToString(valorVenda);
			}

			if (Regex::IsMatch(Convert::ToString((TV / 100)*valorVenda),str)) {
				label22->Text = Regex::Replace(Convert::ToString((TV / 100)*valorVenda),str,"$1");
			} else {
				label22->Text = Convert::ToString((TV / 100)*valorVenda);
			}

			if (MR != 0) {
				if (Regex::IsMatch(Convert::ToString(valorVenda / (M / MR)),str)) {
					label11->Text = Regex::Replace(Convert::ToString(valorVenda / (M / MR)),str,"$1");
				} else {
					label11->Text = Convert::ToString(valorVenda / (M / MR));
				}
				valorizacao = ((((valorVenda / (M / MR)) - MR) * 100) / MR);
				if (Regex::IsMatch(Convert::ToString(valorizacao), str2)) {
					label38->Text = Regex::Replace(Convert::ToString(valorizacao), str2, "$1");
				}
				else {
					label38->Text = Convert::ToString(valorizacao);
				}
			}
		}
		else {
	...
	private: System::Void textBox1_TextChanged(System::Object^  sender, System::EventArgs^  e) {
		if (!String::IsNullOrEmpty(this->textBox1->Text)) {
			if (Regex::IsMatch(this->textBox1->Text, "[0-9]+(,[0-9]+)*$")){
				label44->Text = L"";
				label42->Text = L"";
				...
				if (!String::IsNullOrEmpty(this->textBox2->Text)) {
					...
					if (moedaR != 0) {
						if (Regex::IsMatch(Convert::ToString(montanteR / moedaR), str2)) {
							label12->Text = Regex::Replace(Convert::ToString(montanteR / moedaR), str2, "$1");
						}
						else {
							label12->Text = Convert::ToString(montanteR / moedaR);
						}
					}
				}
			}
			else {
				label44->Text = L"Campo deve ter formato de moeda Ex.: 0,00";
			}
		}
		else {
			label12->Text = L"";
	...
	private: System::Void textBox2_TextChanged(System::Object^  sender, System::EventArgs^  e) {
		if (!String::IsNullOrEmpty(this->textBox2->Text)) {
			if (Regex::IsMatch(this->textBox2->Text, "[0-9]+(,[0-9]+)*$")) {
				label45->Text = L"";
				label43->Text = L"";
				montanteR = Convert::ToDouble(this->textBox2->Text);
				if (!String::IsNullOrEmpty(this->textBox1->Text)) {
				...
				if (!String::IsNullOrEmpty(this->textBox3->Text)) {
					double taxaC = Convert::ToDouble(this->textBox3->Text);
					if (Regex::IsMatch(Convert::ToString((taxaC / 100)*montanteR), str)) {
						label17->Text = Regex::Replace(Convert::ToString((taxaC / 100)*montanteR), str, "$1");
					}
					else {
						label17->Text = Convert::ToString((taxaC / 100)*montanteR);
					}
				}
				if (!String::IsNullOrEmpty(this->textBox4->Text)) {
					lucro = Convert::ToDouble(this->textBox4->Text);
					if (montanteR != 0) {
						if (Regex::IsMatch(Convert::ToString((lucro / 100)*montanteR), str)) {
							label25->Text = Regex::Replace(Convert::ToString((lucro / 100)*montanteR), str, "$1");
						}
						else {
							label25->Text = Convert::ToString((lucro / 100)*montanteR);
						}
					}
				}
				if (!String::IsNullOrEmpty(this->textBox6->Text)) {
					...
					if (montanteR != 0) {
						if (Regex::IsMatch(Convert::ToString(lucroR / montanteR), str)) {
							label26->Text = Regex::Replace(Convert::ToString(lucroR / montanteR), str, "$1");
						}
						else {
							label26->Text = Convert::ToString(lucroR / montanteR);
						}
					}
				}
			}
			else {
				label45->Text = L"Campo deve ter formato de moeda Ex.: 0,00";
			}
		}
		else {
			label12->Text = L"";
	...
	private: System::Void textBox3_TextChanged(System::Object^  sender, System::EventArgs^  e) {
		double taxaC = 0;
		if (!String::IsNullOrEmpty(this->textBox3->Text)) {
			if (Regex::IsMatch(this->textBox3->Text, "[0-9]+(,[0-9]+)*$")) {
				label43->Text = L"";
				label46->Text = L"";
				...
				label46->Text = L"Campo deve ser um número";
			}
		}
		else {
			label18->Text = L"";
	...
	private: System::Void textBox4_TextChanged(System::Object^  sender, System::EventArgs^  e) {
		if (!String::IsNullOrEmpty(this->textBox4->Text)) {
			if (Regex::IsMatch(this->textBox4->Text, "[0-9]+(,[0-9]+)*$")) {
				label47->Text = L"";
				lucro = Convert::ToDouble(this->textBox4->Text);
				if (montanteR != 0) {
					if (Regex::IsMatch(Convert::ToString((lucro / 100)*montanteR), str)) {
				...
				label47->Text = L"Campo deve ser um número";
			}
	...
	private: System::Void textBox5_TextChanged(System::Object^  sender, System::EventArgs^  e) {
		if (!String::IsNullOrEmpty(this->textBox5->Text)) {
			if (Regex::IsMatch(this->textBox5->Text, "[0-9]+(,[0-9]+)*$")) {
				label49->Text = L"";
				taxaV = Convert::ToDouble(this->textBox5->Text);
				label21->Text = Convert::ToString(taxaV / 100);
			}
			else {
				label49->Text = L"Campo deve ser um número";
			}
		}
		else {
			label21->Text = L"";
	...
	private: System::Void textBox6_TextChanged(System::Object^  sender, System::EventArgs^  e) {
		if (!String::IsNullOrEmpty(this->textBox6->Text)) {
			if (Regex::IsMatch(this->textBox6->Text, "[0-9]+(,[0-9]+)*$")) {
				label48->Text = L"";
				lucroR = Convert::ToDouble(this->textBox6->Text);
				if (montanteR != 0) {
					if (Regex::IsMatch(Convert::ToString(lucroR / montanteR), str)) {
